...
<body style="background: #8FBC8F">
    ...
    <div class="container"style="margin-top: 2%;">
            ...
            <center><h3 style="margin-bottom: 4%;">Editar Turma:</h3></center>

                   

                    <form method="post" action="../controllers/ocorrencia.php?acao=atualizarTurma">

                     <input type="hidden" name="cod_turma" value="<?=$_GET['cod_turma']?>">   

                    <div class="form-group"/>
                        <label for="nome">Descrição da turma:</label>
                        <input value="<?= $dados_Turma['desc_turma']?>" name="desc_turma" type="text" class="form-control" id="name"  placeholder="Descrição da Turma:">
                    </div>
                    
                    <div class="form-group"/>
                        <label for="ano">Ano de início:</label>
                        <input value="<?= $dados_Turma['ano']?>" name="ano" type="text" class="form-control" id="name"  placeholder="Ano de ingresso da turma:">
                    </div>
