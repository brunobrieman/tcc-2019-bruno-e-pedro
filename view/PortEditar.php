...
<body style="background: #8FBC8F">
    <div class="container" style="margin-top: 10%;">
       ...
       <center><h3>Editar seu perfil:</h3></center>
        ...
        <form method="post" action="../controllers/portaria.php?acao=atualizar" enctype="multipart/form-data">

            <input type="hidden" name="cod_user" value="<?= $_GET['cod_user'] ?>">

                     <div class="form-group"/>
                        <label for="codPortaria">Código de servidor:</label>
                        <input name="codPortaria" value="<?= $dados_user['codportaria'] ?>"  type="text" class="form-control" id="name"  placeholder="digite seu código de servidor:">
                    </div>
                    <div class="form-group">
                        <label for="cod_user">Código de usuário:</label>
                        <input name="cod_user" type="text" class="form-control" id="email" value="<?= $dados_user['cod_user'] ?>"  placeholder="fornecido pelo Nupe:">
                    </div>
                    <div class="form-group">
